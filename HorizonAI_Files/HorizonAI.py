...
def Greeting():
    Greetings = ["Hi", "Hello", "What's up", "Whats up", "Howdy", "Sup", "Hey"]
...
def AltGreeting():
    AltGreetings = ["How are you", "Howve you been", "How've you been"]
...
Query = input("Hi, I'm HorizonAI. Ask me anything!")
